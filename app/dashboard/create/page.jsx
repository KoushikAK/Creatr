  ...
  if (isDraftLoading || userLoading) {
    return (
      <div className="flex items-center justify-center min-h-96">
        <div className="w-96 h-1.5 bg-slate-700 rounded-full overflow-hidden">
          <div className="h-full bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 animate-[loader_1.2s_ease-in-out_infinite]" />
        </div>
        <style jsx>{`
          @keyframes loader {
            0% {
